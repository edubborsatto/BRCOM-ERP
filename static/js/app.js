...
import {initSuggestions,loadSuggestions,loadNotifications,refreshNotificationBadge} from './suggestions.js?v=6.0.0';
...
initCatalog();initOperations();initAdministration();initImports();initSalesSheets();initSuggestions();
