import {$,api,state,toast,showError} from './api.js?v=5.2.0';
import {initCatalog,loadProducts,loadFormulas} from './catalog.js?v=5.2.0';
import {initOperations,loadDashboard,loadQuotes,loadOrders,loadSales,loadReports} from './operations.js?v=5.2.0';
import {initAdministration,loadClients,loadAgenda,loadFutureOrders,loadHistory,loadUsers} from './administration.js?v=5.2.0';
import {initImports,loadImports} from './imports.js?v=5.2.0';
import {initSalesSheets,loadSalesSheet} from './sales-sheets.js?v=5.2.0';
import {initSuggestions,loadSuggestions,loadNotifications,refreshNotificationBadge} from './suggestions.js?v=5.2.0';

const loaders={dashboardTab:loadDashboard,produtosTab:loadProducts,estoqueTab:loadProducts,formulasTab:loadFormulas,orcamentosTab:loadQuotes,osTab:loadOrders,vendasTab:loadSales,importacoesTab:loadImports,planilhasVendasTab:loadSalesSheet,relatoriosTab:loadReports,clientesTab:loadClients,agendaTab:loadAgenda,pedidosTab:loadFutureOrders,historicoTab:async()=>{await loadProducts();return loadHistory()},sugestoesTab:loadSuggestions,notificacoesTab:loadNotifications,usuariosTab:loadUsers};
const titles={dashboardTab:'Painel',produtosTab:'Produtos',estoqueTab:'Movimentar estoque',formulasTab:'Fórmulas',orcamentosTab:'Orçamentos',osTab:'Ordens de serviço',vendasTab:'Vendas',importacoesTab:'Importar planilhas',planilhasVendasTab:'Planilhas de Vendas',relatoriosTab:'Relatórios',clientesTab:'Clientes',agendaTab:'Agenda',pedidosTab:'Pedidos futuros',historicoTab:'Auditoria',sugestoesTab:'Sugestões',notificacoesTab:'Notificações',usuariosTab:'Usuários'};
...
initTheme();initCatalog();initOperations();initAdministration();initImports();initSalesSheets();initSuggestions();
